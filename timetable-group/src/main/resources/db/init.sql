...
grant connect on database pnu_system to group_role;
grant usage on schema group_microservice to group_role;
grant all on schema group_microservice to su_role;

create user group_user nosuperuser nocreatedb nocreaterole login encrypted password '12345';
