...
import com.pnu.system.laboratorycontrol.mapper.LaboratoryControlSubjectSnapshotMapper;
...
public class LaboratoryControlSubjectSnapshotService implements MessagingSnapshotService<SubjectSnapshotDto> {

    private final TimetableRestClient restClient;
    private final LaboratoryControlSubjectSnapshotMapper mapper;
    private final LaboratoryControlSubjectSnapshotRepository repository;
    ...
    public void synchronize() {
        ...
        try {
            ...
            repository.saveAll(received.stream().map(mapper::asLaboratoryControlSubjectSnapshot).toList());
    ...
    public void receiveSnapshot(SubjectSnapshotDto snapshot) {
        LaboratoryControlSubjectSnapshot user = mapper.asLaboratoryControlSubjectSnapshot(snapshot);
